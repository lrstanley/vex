...
func (tc *ThemeConfig) generateChromaStyle() chroma.StyleEntries {
	...
	return chroma.StyleEntries{
		...
		chroma.Keyword:                  chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		chroma.KeywordConstant:          chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		chroma.KeywordDeclaration:       chromaCompat(s.Foreground(t.Cyan).Italic(true)),
		chroma.KeywordNamespace:         chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		chroma.KeywordPseudo:            chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		chroma.KeywordReserved:          chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		...
		chroma.NameTag:                  chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		...
		chroma.LiteralNumber:            chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.LiteralNumberBin:         chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.LiteralNumberFloat:       chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.LiteralNumberHex:         chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.LiteralNumberInteger:     chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.LiteralNumberIntegerLong: chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.LiteralNumberOct:         chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40)))),
		chroma.Operator:                 chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		chroma.OperatorWord:             chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
		chroma.Punctuation:              chromaCompat(s.Foreground(t.BrightWhite)),
		chroma.Comment:                  chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40))).Faint(true)),
		chroma.CommentHashbang:          chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40))).Faint(true)),
		chroma.CommentMultiline:         chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40))).Faint(true)),
		chroma.CommentSingle:            chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40))).Faint(true)),
		chroma.CommentSpecial:           chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.Purple, 30), colors.Lighten(t.Purple, 40))).Faint(true)),
		chroma.CommentPreproc:           chromaCompat(s.Foreground(tc.adapt(colors.Darken(t.BrightPurple, 30), colors.Lighten(t.BrightPurple, 20)))),
